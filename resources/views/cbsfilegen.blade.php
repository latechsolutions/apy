...
<div class="panel-group" id="masterdiv">
  <div class="panel panel-warning">
    ...
    <div id="collapse1" class="panel-collapse collapse">
      <div class="panel-body">
        <form method="post" action="{{ url('gencbsfile') }}/newgen">
        {{ csrf_field() }}
  ...
  <div class="panel panel-primary">
    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body">
        <form method="post" action="{{ url('gencbsfile') }}/regen">
        {{ csrf_field() }}
          <div class="col-md-8">
            <select id="rfname" name="rfname" class="form-control">
              @foreach($existingfiles as $file)
              <option value="{{ $file->cbs_file_name }}">{{ $file->cbs_file_name }}</option>
              @endforeach
            </select>
          </div>
  ...
  <div class="panel panel-warning">
    ...
    <div id="collapse4" class="panel-collapse collapse">
      <div class="panel-body">
        <form method="post" action="{{ url('gencbsfile') }}/uploadresponse" enctype="multipart/form-data">
        {{ csrf_field() }}
          <div class="col-md-8">
