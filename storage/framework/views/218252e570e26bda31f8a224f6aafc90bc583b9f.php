    ...
    <div class="row  form-group-sm ">
      <div class="col-md-9 col-md-offset-3 form-inline">
         ...
         <div class="col-sm-6" style="padding:0px">
          ...
          <input class="form-control" type="text" id="cbsacno_brcd" name="cbsacno_brcd" value="<?php echo e(old('cbsacno_brcd')); ?>" size="4" /> 
         
            </div>
            <div class="col-sm-3" style="padding:0px">
             <input class="form-control" type="text" id="cbsacno_acno" name="cbsacno_acno" value="<?php echo e(old('cbsacno_acno')); ?>" size="9" /> 
            </div>
            <div class="col-sm-2">
             <input type="button" class="form-control btn btn-success" value="Get CBS Details" id="getcbsbut" />
              </div>
            <?php if($errors->has('cbsacno_brcd')): ?>
          <span class="help-block">
                                        <strong><?php echo e($errors->first('cbsacno_brcd')); ?></strong>
                                    </span> <?php endif; ?>
              <?php if($errors->has('cbsacno_acno')): ?>
          <span class="help-block">
                                        <strong><?php echo e($errors->first('cbsacno_acno')); ?></strong>
                                    </span> <?php endif; ?>
        </div>
...
<script>
  ...
  return str.length < max ? pad("0" + str, max) : str;
    ...
    $('#getcbsbut').click(function() {
      ...
      $.get("<?php echo e(url('/getcbsdetails')); ?>/cid/" + cbsacno, function(data) {
