...
<div class="panel-group" id="masterdiv">
  <div class="panel panel-warning">
    ...
    <div id="collapse1" class="panel-collapse collapse">
      <div class="panel-body">
        <form method="post" action="<?php echo e(url('genmodfile')); ?>/<?php echo e($action); ?>/newgen">
  ...
  <div class="panel panel-primary">
    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body">
        <form method="post" action="<?php echo e(url('genmodfile')); ?>/<?php echo e($action); ?>/regen">
        <?php echo e(csrf_field()); ?>
  ...
  <div class="panel panel-warning">
    ...
    <div id="collapse4" class="panel-collapse collapse">
      <div class="panel-body">
        <form method="post" action="<?php echo e(url('genmodfile')); ?>/<?php echo e($action); ?>/uploadresponse" enctype="multipart/form-data">
        <?php echo e(csrf_field()); ?>
